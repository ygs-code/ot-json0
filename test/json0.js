...
genTests = function (type) {
  ...
  describe('number', function () {
    it('Adds a number', function () {
      ...
      return assert.deepEqual([3], type.apply([1], [
        {
          p: [0],
          na: 2
        }
    ...
    it('doesn\'t overwrite values when it merges na in append', function () {
      ...
      _ref = transformX(type, rightOp, leftOp), right_ = _ref[0], left_ = _ref[1];
      s_c = type.apply(rightHas, left_);
      c_s = type.apply(leftHas, right_);
      return assert.deepEqual(s_c, c_s);
    });
    it('throws when adding a string to a number', function () {
    ...
    return it('throws when adding a number to a string', function () {
      return assert.throws(function () {
        return type.apply('a', [
          {
            p: [],
  ...
  describe('string', function () {
    describe('#apply()', function () {
      return it('works', function () {
        ...
        return it('throws when the inserted content is not a string', function () {
          return assert.throws(function () {
            return type.apply('a', [
              {
                p: [0],
    ...
    return describe('#transform()', function () {
      it('splits deletes', function () {
        return assert.deepEqual(type.transform([
          {
            p: [0],
            sd: 'ab'
          }
  ...
  describe('list', function () {
    describe('apply', function () {
      it('inserts', function () {
        ...
        return assert.deepEqual(['a', 'b', 'c'], type.apply(['a', 'b'], [
          {
            p: [2],
            li: 'c'
          }
      ...
      it('deletes', function () {
        ...
        return assert.deepEqual(['a', 'b'], type.apply(['a', 'b', 'c'], [
          {
            p: [2],
            ld: 'c'
          }
      ...
      it('replaces', function () {
        return assert.deepEqual(['a', 'y', 'b'], type.apply(['a', 'x', 'b'], [
          {
            p: [1],
            ld: 'x',
            li: 'y'
      ...
      it('moves', function () {
        ...
        return assert.deepEqual(['a', 'b', 'c'], type.apply(['b', 'a', 'c'], [
          {
            p: [0],
            lm: 1
          }
      ...
      it('throws when keying a list replacement with a string', function () {
        return assert.throws(function () {
          return type.apply(['a', 'b', 'c'], [
            {
              p: ['0'],
              li: 'x',
              ld: 'a'
      ...
      it('throws when keying a list insertion with a string', function () {
        return assert.throws(function () {
          return type.apply(['a', 'b', 'c'], [
            {
              p: ['0'],
      ...
      it('throws when keying a list deletion with a string', function () {
        return assert.throws(function () {
          return type.apply(['a', 'b', 'c'], [
            {
              p: ['0'],
      ...
      it('throws when keying a list move with a string', function () {
        return assert.throws(function () {
          return type.apply(['a', 'b', 'c'], [
            {
              p: ['0'],
      ...
      it('throws when specifying a string as a list move target', function () {
        return assert.throws(function () {
          return type.apply(['a', 'b', 'c'], [
            {
              p: [1],
      ...
      return it('throws when an array index part-way through the path is a string', function () {
        return assert.throws(function () {
          return type.apply({
            arr: [
              {
  ...
  describe('object', function () {
    ...
    it('replacement vs. replacement', function () {
      ...
      _ref = transformX(type, leftOps, rightOps), left_ = _ref[0], right_ = _ref[1];
    ...
    it('throws when the insertion key is a number', function () {
      return assert.throws(function () {
        return type.apply({
          '1': 'a'
        }, [
    ...
    it('throws when the deletion key is a number', function () {
      return assert.throws(function () {
        return type.apply({
          '1': 'a'
        }, [
    ...
    return it('throws when an object key part-way through the path is a number', function () {
      return assert.throws(function () {
        return type.apply({
          '1': {
            x: 'a'
