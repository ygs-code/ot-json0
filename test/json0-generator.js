var clone, genRandomOp, json0, randomInt, randomKey, randomNewKey, randomPath, randomReal, randomThing, randomWord, _ref;
...
randomThing = function () {
  ...
  switch (randomInt(6)) {
    ...
    case 4:
      _results = [];
      for (_j = 1, _ref2 = randomInt(5); 1 <= _ref2 ? _j <= _ref2 : _j >= _ref2; 1 <= _ref2 ? _j++ : _j--) {
